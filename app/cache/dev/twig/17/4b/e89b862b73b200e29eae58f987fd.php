...
/* FrameworkBundle:Exception:exception.twig.html */
class __TwigTemplate_174be89b862b73b200e29eae58f987fd extends Twig_Template
{
...
" => "<br />")));
    ...
    ";
        ...
        foreach ($context['_seq'] as $context['position'] => $context['e']) {
            // line 28
            echo "        ";
            $template = "FrameworkBundle:Exception:traces.twig.html";
    ...
    ";
        ...
        if ($this->getContext($context, 'logger', '31')) {
            ...
            <div id=\"logs\" style=\"display: none\">
                ";
            // line 41
            $template = "FrameworkBundle:Exception:logs.twig.html";
            if ($template instanceof Twig_Template) {
...
";
    ...
    {
        return "FrameworkBundle:Exception:exception.twig.html";
    }
}
