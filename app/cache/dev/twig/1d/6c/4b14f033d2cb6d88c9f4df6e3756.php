...
/* WebProfilerBundle:Collector:request.twig.html */
class __TwigTemplate_1d6c4b14f033d2cb6d88c9f4df6e3756 extends Twig_Template
{
    protected $parent;
...
";
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, 'collector', '16'), "requestquery", array(), "any", false, 16), "all", array(), "any", false, 16))) {
            // line 17
            echo "        ";
            $template = "WebProfilerBundle:Profiler:bag.twig.html";
    ...
    {
        return "WebProfilerBundle:Collector:request.twig.html";
    }
}
