...
class app_devUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    {
        return array(array (  'name' => '{name}',), array_merge($this->defaults, array (  '_controller' => 'Application\\JonTestBundle\\Controller\\JonTestController::indexAction',)), array (), array (  0 =>   array (    0 => 'variable',    1 => '/',    2 => '{name}',    3 => 'name',  ),  1 =>   array (    0 => 'text',    1 => '/',    2 => 'hello',    3 => NULL,  ),));
    }

    protected function getdawgRouteInfo()
    {
        return array(array (  'name' => '{name}',), array_merge($this->defaults, array (  '_controller' => 'Application\\JonTestBundle\\Controller\\JonTestController::indexAction',)), array (), array (  0 =>   array (    0 => 'variable',    1 => '/',    2 => '{name}',    3 => 'name',  ),  1 =>   array (    0 => 'text',    1 => '/',    2 => 'dawg',    3 => NULL,  ),));
    }
